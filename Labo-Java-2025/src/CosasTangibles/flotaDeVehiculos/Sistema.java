...
public class Sistema {
    public static void main(String[] args) {
        ...
        f.addBicicleta(new Bicicleta("Bianchi","Infinito CV",Color.TEAL,2,new Fecha(7,6,2024)));
        f.addBicicleta(new Bicicleta("Merida","Reacto 5000",Color.ORANGE,2,new Fecha(11,11,2024)));
        f.addBicicleta(new Bicicleta("Orbea","Orca M20",Color.MAGENTA,2,new Fecha(4,4,2025)));
