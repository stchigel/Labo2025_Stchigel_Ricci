...
public class momooooooo {
    ...
    *
    * pero si me voy quizas falte todo
    * ella me llama me llama y no se que ahcer
    * llama y me llama y si volvere
    * porque tu eres mi pasado
    * lo mejor que me habia pasado tambien
    *
    *
    * no tntntntn
    * salsa roja
    * carne
    * muzzarela
    * y se le ralla levemente grueso
    * queso parmichiano
    *
    * estuviste cerca de jugar en primera
    * casi
    *
    * NO ME REVUELVAS LOS ÑOQUIS
    *
    * UN OSO WACHO
    *
    * uuujujujujj manteca AJAJAJSajJA
    *
    * y esos auris de virgo momo
    * juanseto 01 vos sabes que te vas baneado
    *
    * pero yo tengo 3 propiedades
    *
    * 4 cafeteras
    *
    * mi entrenador me dice que tengo dos ladrillos de manos
    *
    * a mi me gusta el regueton de la vieja escuela
    * daddy yankee
    * tito calderon
    *
    * viruzz*/
